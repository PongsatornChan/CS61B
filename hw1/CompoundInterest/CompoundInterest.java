...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
        ...
        double percent = (100.0+rate)/100.0;
        int numYear = numYears(targetYear);
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double nomiValue = futureValue(presentValue, rate, targetYear);
        double realValue = futureValue(nomiValue, -1.0*inflationRate, targetYear);
        return realValue;
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        ...
        for(int i = 0; i < numYears(targetYear); i++) {
            sum += futureValue(perYear, rate, targetYear-i);
        }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        double nomiValue = totalSavings(perYear, targetYear, rate);
        nomiValue = futureValue(nomiValue, -1.0*inflationRate, targetYear);
        return nomiValue;
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = totalSavings(10000, targetYear, returnRate); // replace 0 with your code
        double realSavings = totalSavingsReal(10000, targetYear, returnRate, inflationRate);   // replace 0 with your code
        // Do not change anything in this method below this line
